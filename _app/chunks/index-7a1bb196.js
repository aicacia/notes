 ...
 */(function(module,exports){(function(e,n){module.exports=n()})(window,function(){return function(t){var e={};function n(o){if(e[o])return e[o].exports;var i=e[o]={i:o,l:!1,exports:{}};return t[o].call(i.exports,i,i.exports,n),i.l=!0,i.exports}return n.m=t,n.c=e,n.d=function(o,i,s){n.o(o,i)||Object.defineProperty(o,i,{enumerable:!0,get:s})},n.r=function(o){typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(o,"__esModule",{value:!0})},n.t=function(o,i){if(i&1&&(o=n(o)),i&8||i&4&&typeof o=="object"&&o&&o.__esModule)return o;var s=Object.create(null);if(n.r(s),Object.defineProperty(s,"default",{enumerable:!0,value:o}),i&2&&typeof o!="string")for(var a in o)n.d(s,a,function(l){return o[l]}.bind(null,a));return s},n.n=function(o){var i=o&&o.__esModule?function(){return o.default}:function(){return o};return n.d(i,"a",i),i},n.o=function(o,i){return Object.prototype.hasOwnProperty.call(o,i)},n.p="",n(n.s=0)}({"./assets/icons/align-center.svg":function(module,exports){eval(`// Module
...
//# sourceURL=webpack://Quill/./util.inspect_(ignored)?`)}}).default})})(quill);var Quill=getDefaultExportFromCjs(quill.exports);/*!
 * long-press-event - v@version@
 * Pure JavaScript long-press-event
 * https://github.com/john-doherty/long-press-event
 * @author John Doherty <www.johndoherty.info>
 * @license MIT
 */(function(t,e){var n=null,o="PointerEvent"in t||t.navigator&&"msPointerEnabled"in t.navigator,i="ontouchstart"in t||navigator.MaxTouchPoints>0||navigator.msMaxTouchPoints>0,s=o?"pointerdown":i?"touchstart":"mousedown",a=o?"pointerup":i?"touchend":"mouseup",l=o?"pointermove":i?"touchmove":"mousemove",f=0,d=0,m=10,b=10;typeof t.CustomEvent!="function"&&(t.CustomEvent=function(r,_){_=_||{bubbles:!1,cancelable:!1,detail:void 0};var u=e.createEvent("CustomEvent");return u.initCustomEvent(r,_.bubbles,_.cancelable,_.detail),u},t.CustomEvent.prototype=t.Event.prototype),t.requestAnimFrame=function(){return t.requestAnimationFrame||t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||t.oRequestAnimationFrame||t.msRequestAnimationFrame||function(r){t.setTimeout(r,1e3/60)}}();function y(r,_){if(!t.requestAnimationFrame&&!t.webkitRequestAnimationFrame&&!(t.mozRequestAnimationFrame&&t.mozCancelRequestAnimationFrame)&&!t.oRequestAnimationFrame&&!t.msRequestAnimationFrame)return t.setTimeout(r,_);var u=new Date().getTime(),c={},h=function(){var D=new Date().getTime(),A=D-u;A>=_?r.call():c.value=requestAnimFrame(h)};return c.value=requestAnimFrame(h),c}function g(r){r&&(t.cancelAnimationFrame?t.cancelAnimationFrame(r.value):t.webkitCancelAnimationFrame?t.webkitCancelAnimationFrame(r.value):t.webkitCancelRequestAnimationFrame?t.webkitCancelRequestAnimationFrame(r.value):t.mozCancelRequestAnimationFrame?t.mozCancelRequestAnimationFrame(r.value):t.oCancelRequestAnimationFrame?t.oCancelRequestAnimationFrame(r.value):t.msCancelRequestAnimationFrame?t.msCancelRequestAnimationFrame(r.value):clearTimeout(r))}function E(r){p(),r=v(r);var _=this.dispatchEvent(new CustomEvent("long-press",{bubbles:!0,cancelable:!0,detail:{clientX:r.clientX,clientY:r.clientY},clientX:r.clientX,clientY:r.clientY,offsetX:r.offsetX,offsetY:r.offsetY,pageX:r.pageX,pageY:r.pageY,screenX:r.screenX,screenY:r.screenY}));_||e.addEventListener("click",function u(c){e.removeEventListener("click",u,!0),O(c)},!0)}function v(r){return r.changedTouches!==void 0?r.changedTouches[0]:r}function x(r){p();var _=r.target,u=parseInt(w(_,"data-long-press-delay","1500"),10);n=y(E.bind(_,r),u)}function p(r){g(n),n=null}function O(r){r.stopImmediatePropagation(),r.preventDefault(),r.stopPropagation()}function P(r){f=r.clientX,d=r.clientY,x(r)}function k(r){var _=Math.abs(f-r.clientX),u=Math.abs(d-r.clientY);(_>=m||u>=b)&&p()}function w(r,_,u){for(;r&&r!==e.documentElement;){var c=r.getAttribute(_);if(c)return c;r=r.parentNode}return u}e.addEventListener(a,p,!0),e.addEventListener(l,k,!0),e.addEventListener("wheel",p,!0),e.addEventListener("scroll",p,!0),e.addEventListener(s,P,!0)})(window,document);const Embed=Quill.import("blots/embed");class Formula extends Embed{static create(e){if(window.katex==null)throw new Error("Formula module requires KaTeX.");const n=super.create(e&&e.expr);return typeof e=="object"&&(window.katex.render(e.expr,n,{displayMode:!!e.block,throwOnError:!1,errorColor:"#f00"}),n.setAttribute("data-value",e.expr),e.block&&n.setAttribute("data-block","true")),n}static value(e){return{expr:e.getAttribute("data-value"),block:Boolean(e.getAttribute("data-block"))}}html(){const{formula:e}=this.value();return`<span data-value="${e.expr}" ${e.block?'data-block="true"':""}">${e.expr}</span>`}}Formula.blotName="formula";Formula.className="ql-formula";Formula.tagName="SPAN";Quill.register({"formats/formula":Formula},!0);const Parchment=Quill.import("parchment"),Registry=Parchment.Registry,LinkBlot=Quill.import("formats/link"),Tooltip=Quill.import("ui/tooltip");class RichEditorTooltip extends Tooltip{constructor(e,n){super(e,n||e.container);this.textbox=this.root.querySelector('input[type="text"]'),this.textarea=this.root.querySelector("textarea"),this.katex=this.root.querySelector("div.ql-katex"),this.block=this.root.querySelector("input.ql-block"),this.listen()}listen(){const e=this.quill.container,n=this.quill.root,o=n.ownerDocument,i=a=>{if(!o.body.contains(this.quill.root)){o.body.removeEventListener("click",i);return}!e.contains(a.target)&&!this.root.classList.contains("ql-hidden")&&!this.root.hasAttribute("data-mode")&&(this.hide(),a.preventDefault(),a.stopPropagation())};o.body.addEventListener("click",i),n.setAttribute("data-long-press-delay","300"),n.addEventListener("long-press",a=>{if(this.root.classList.contains("ql-editing"))return;const l=this.quill.getSelection(!0);l&&(this.openAt(l),a.preventDefault(),a.stopPropagation())}),e.addEventListener("click",a=>{const l=Registry.find(a.target,!0);l&&l instanceof Formula&&(this.range={index:l.offset(this.quill.scroll),length:l.length()},this.edit("formula",Formula.value(l.domNode)),a.preventDefault(),a.stopPropagation())},{capture:!0});const s=()=>{window.katex.render(this.textarea.value,this.katex,{displayMode:this.block.checked,throwOnError:!1,errorColor:"#f00"})};this.textarea.addEventListener("input",s),this.block.addEventListener("change",s),this.textbox.addEventListener("keydown",a=>{a.key==="Enter"?(this.save(),a.preventDefault()):a.key==="Escape"&&(this.cancel(),a.preventDefault())}),this.quill.on("selection-change",(a,l,f)=>{if(a!=null&&f==="user")if(a.length===0&&!this.root.classList.contains("ql-hidden"))this.hide();else if(a.length>0)this.openAt(a);else{const[d,m]=this.quill.scroll.descendant(LinkBlot,a.index);d!=null&&(this.range={index:a.index-m,length:d.length()},this.edit("link",LinkBlot.formats(d.domNode)))}}),this.root.querySelector(".ql-save")?.addEventListener("click",()=>{this.save()}),this.root.querySelector(".ql-close")?.addEventListener("click",()=>{this.hide()}),this.quill.on("scroll-optimize",()=>{setTimeout(()=>{if(this.root.classList.contains("ql-hidden"))return;const a=this.quill.getSelection();a!=null&&this.position(this.quill.getBounds(a.index,a.length))},1)}),this.quill.keyboard.addBinding({key:"m",ctrlKey:!0},{collapsed:!0},a=>{this.range={index:a.index,length:a.length},this.edit("formula")})}openAt(e){this.show(),this.root.style.left="0px",this.root.style.width="",this.root.style.width=`${this.root.offsetWidth}px`;const n=this.quill.getLines(e.index,e.length);if(n.length<=1)this.position(this.quill.getBounds(e.index,e.length));else{const o=n[n.length-1],i=this.quill.getIndex(o),s=Math.min(o.length()-1,e.index+e.length-i),a=this.quill.getBounds(i,s);this.position(a)}}position(e){const n=e.left+e.width/2-this.root.offsetWidth/2,o=e.bottom+this.quill.root.scrollTop;this.root.style.left=`${n}px`,this.root.style.top=`${o}px`;const i=this.boundsContainer.getBoundingClientRect(),s=this.root.getBoundingClientRect();let a=0;s.right>i.right&&(a=i.right-s.right,this.root.style.left=`${n+a}px`),s.left<i.left&&(a=i.left-s.left,this.root.style.left=`${n+a}px`);const l=this.root.querySelector(".ql-tooltip-arrow");return l.style.marginLeft="",a!==0&&(l.style.marginLeft=`${-1*a-l.offsetWidth/2}px`),a}show(){this.root.classList.remove("ql-editing"),this.root.classList.remove("ql-hidden"),this.textbox&&(this.textbox.value=""),this.textarea&&(this.textarea.value=""),this.katex&&(this.katex.innerHTML=""),this.block&&(this.block.value="false",this.block.checked=!1),this.root.removeAttribute("data-mode")}hide(){this.root.classList.remove("ql-editing"),this.root.classList.add("ql-hidden"),this.root.removeAttribute("data-mode")}cancel(){this.show()}edit(e,n){this.root.classList.remove("ql-hidden"),this.root.classList.add("ql-editing"),n!=null&&(e==="formula"&&typeof n=="object"?(this.block.value=(!!n.block).toString(),this.block.checked=!!n.block,this.textarea.value=n.expr,this.textbox.value=""):(this.textbox.value=n,this.textarea.value="")),this.position(this.quill.getBounds(this.quill.selection.savedRange)),e==="formula"?this.textarea.select():(this.textbox.select(),this.textbox.setAttribute("placeholder",this.textbox.getAttribute(`data-${e}`)||"")),this.root.setAttribute("data-mode",e)}restoreFocus(){const e=this.quill.scrollingContainer,n=e.scrollTop;this.quill.focus(),e.scrollTop=n}save(){const e=this.root.getAttribute("data-mode");let n=e==="formula"?this.textarea.value:this.textbox.value;switch(e){case"link":{const o=this.quill.root.scrollTop;this.range?(this.quill.formatText(this.range,"link",n,"user"),this.range=void 0):(this.restoreFocus(),this.quill.format("link",n,"user")),this.quill.root.scrollTop=o;break}case"video":n=extractVideoUrl(n);case"formula":{if(!n)break;this.range&&(this.quill.deleteText(this.range.index,this.range.length,"user"),this.range=void 0);const o=this.quill.getSelection(!0);if(o!=null){const i=o.index+o.length;e==="formula"?(this.quill.insertEmbed(i,e,{expr:n,block:this.block.checked},"user"),this.quill.insertText(i+1," ","user")):this.quill.insertEmbed(i,e,n,"user"),this.quill.setSelection(i+2,0,"user")}break}}this.hide()}}RichEditorTooltip.TEMPLATE=['<span class="ql-tooltip-arrow"></span>','<div class="ql-tooltip-editor">','<input type="text" data-link="https://quilljs.com" data-video="Embed URL"/>','<textarea placeholder="e=mc^2"></textarea>','<div class="ql-katex"></div>','<a class="ql-close"></a>','<a class="ql-save"></a>','<input type="checkbox" class="ql-block" />',"</div>"].join("");function extractVideoUrl(t){let e=t.match(/^(?:(https?):\/\/)?(?:(?:www|m)\.)?youtube\.com\/watch.*v=([a-zA-Z0-9_-]+)/)||t.match(/^(?:(https?):\/\/)?(?:(?:www|m)\.)?youtu\.be\/([a-zA-Z0-9_-]+)/);return e?`${e[1]||"https"}://www.youtube.com/embed/${e[2]}?showinfo=0`:(e=t.match(/^(?:(https?):\/\/)?(?:www\.)?vimeo\.com\/(\d+)/))?`${e[1]||"https"}://player.vimeo.com/video/${e[2]}/`:t}const BubbleTheme=Quill.import("themes/snow"),Theme=Quill.import("core/theme"),icons=Quill.import("ui/icons"),TOOLBAR_CONFIG=[[{header:["1","2","3",!1]}],["bold","italic","underline","strike"],[{color:[]},{background:[]}],["code-block","formula"],[{list:"ordered"},{list:"bullet"}],[{align:[]}],["link","image"],["clean"]],BUBBLE_DEFAULTS=BubbleTheme.DEFAULTS;class RichEditorTheme extends Theme{constructor(e,n){n.modules&&n.modules.toolbar!=null&&n.modules.toolbar.container==null&&(n.modules.toolbar.container=TOOLBAR_CONFIG);super(e,n);this.quill.container.classList.add("ql-rich-editor")}extendToolbar(e){e.container.classList.add("ql-rich-editor"),this.tooltip=new RichEditorTooltip(this.quill,this.options.bounds),this.tooltip.root.appendChild(e.container),this.buildButtons(e.container.querySelectorAll("button"),icons),this.buildPickers(e.container.querySelectorAll("select"),icons)}}RichEditorTheme.DEFAULTS={...BUBBLE_DEFAULTS,modules:{...BUBBLE_DEFAULTS.modules,toolbar:{...BUBBLE_DEFAULTS.modules.toolbar,handlers:{...BUBBLE_DEFAULTS.modules.toolbar.handlers,link(t){if(t){const e=this.quill.getSelection();if(e==null||e.length===0)return;let n=this.quill.getText(e);/^\S+@\S+\.\S+$/.test(n)&&n.indexOf("mailto:")!==0&&(n=`mailto:${n}`),this.quill.theme.tooltip.edit("link",n)}else this.quill.format("link",!1)}}}}};RichEditorTheme.prototype.init=BubbleTheme.prototype.init;RichEditorTheme.prototype.addModule=BubbleTheme.prototype.addModule;RichEditorTheme.prototype.buildButtons=BubbleTheme.prototype.buildButtons;RichEditorTheme.prototype.buildPickers=BubbleTheme.prototype.buildPickers;Quill.register("themes/rich-editor",RichEditorTheme,!0);function createQuill(t,e){return new Quill(t,{placeholder:e,theme:"rich-editor"})}function renderQuill(t,e){t.innerHTML=`<div class="ql-container ql-snow ql-rich-editor ql-read-only"><div class="ql-editor">${e.root.innerHTML}</div></div>`,Array.from(t.querySelectorAll(".ql-code-block")).forEach(n=>{n.innerHTML=lib.highlight(n.getAttribute("data-language"),n.innerText).value})}function renderOps(t,e){const n=getOrCreateTmpNode(t.ownerDocument),o=createQuill(n);o.setContents({ops:e}),renderQuill(t,o),n.innerHTML=""}const TMP_NODE_ID="quill-render-tmp-node";function getOrCreateTmpNode(t){let e=t.getElementById(TMP_NODE_ID);return e||(e=t.createElement("div"),e.id=TMP_NODE_ID,e.style.display="none",t.body.appendChild(e)),e}export{RichEditorTheme,createQuill,renderOps,renderQuill};
